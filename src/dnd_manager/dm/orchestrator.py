...
from dnd_manager.core.exceptions import GameEngineError
...
from .dice import DiceResult, roll_attack, roll_check, roll_damage, roll_dice, roll_save
...
# =============================================================================
# Dice rolling functions imported from dice.py
# System prompt imported from prompts.py
# Tool base classes imported from tools/base.py
# =============================================================================

# (Dice rolling code moved to dice.py)
# (System prompt moved to prompts.py)
# (ToolResult and DMTool moved to tools/base.py)

# TODO: In future refactoring, move tool handlers to:
# - tools/combat.py: combat-related handlers
# - tools/entity.py: entity management handlers  
# - tools/query.py: query and info handlers
# - tools/spell.py: spellcasting handlers


# (Dice rolling code removed - now in dice.py)
...
# =============================================================================
# DM System Prompt (moved to prompts.py)
# =============================================================================

# (DM_SYSTEM_PROMPT moved to prompts.py and imported above)
